...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="foxml:datastream[@ID='RELS-EXT']/foxml:datastreamVersion[last()]"
        ...
        <!-- Add collection name to the indexed fields based on
        https://ficial.wordpress.com/2014/04/14/islandora-7-solr-faceting-by-collection-name-or-label/ - BD customization 2018 -->
